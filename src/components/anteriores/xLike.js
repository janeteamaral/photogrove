...
import dialogo from '../images/dialogo.jpg';
import enviar from '../images/enviar.jpg';
...
function Like(props) {
  ...
  if (loading) return "Loading Like.js  ...";
  ...
  return (
    <div className="post-like-container">
      {isAuthenticated && (
       ...
       <img src={dialogo} alt="diálogo"> </img>
       <img src={enviar} alt="Enviar"> </img>
